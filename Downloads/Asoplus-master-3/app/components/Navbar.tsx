...
import asopluslogo from "../../public/asopluslogo.svg"
...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      viewport={{ once: true }}
    >
      <Image src={asopluslogo} alt="ASOPLUS" width={67} height={32} loading="eager" />
      ...
      <ul className="list-none sm:flex hidden justify-end items-center flex-1">
        {navLinks.map((nav, index) => (
          <li
            ...
            onClick={() => handleNavClick(nav.title, nav.href)}
          >
